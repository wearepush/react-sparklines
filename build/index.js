    ...
    _createClass(Sparklines, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                max = _props.max,
                min = _props.min,
                disableTooltips = _props.disableTooltips;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.Children.map(this.props.children, function (child) {
                    return _react2.default.cloneElement(child, { data: data, points: points, width: width, height: height, margin: margin, disableTooltips: disableTooltips });
                })
            );
        }
    }]);
...
Sparklines.propTypes = {
    ...
    disableTooltips: _propTypes2.default.bool
};
